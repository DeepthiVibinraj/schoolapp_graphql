...
class HomeworkController extends GetxController {
  ...
  //     final String classLevel = students[activeIndex]['classLevel'];
  ...
  // /// ✅ 1. Fetch homework based on logged-in user's class name (e.g., "5D")
  // Future<void> fetchHomeworkForCurrentUser(String email) async {
  //   isLoading(true);
  //   print('-------------------');
  ...
  //     // ✅ classLevel is now a string like "5D", not ObjectId
  //     final String classLevel = students[0]['classLevel'];

  //     // Step 2: Get homework by classLevel (as string)
  //     const homeworkQuery = r'''
  //       query GetHomeworkByClassLevel($classLevel: String!) {
  //         getHomeworkByClassLevel(classLevel: $classLevel) {
  //           classLevel
